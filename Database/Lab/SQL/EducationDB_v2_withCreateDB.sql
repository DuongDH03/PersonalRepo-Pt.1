...
-- SQLServer: ALTER TABLE student ADD CONSTRAINT student_chk_age CHECK(DATEDIFF(YEAR, dob, current_date) BETWEEN 18 AND 100);
-- SQLServer: ALTER TABLE lecturer ADD CONSTRAINT lecturer_chk_age CHECK(DATEDIFF(YEAR, dob, current_date) BETWEEN 22 AND 100);
